...
class CategorySeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $enTitle = ['Allergology', 'Antibacterial drugs', 'Antihistamines', 'Antimicrobials', 'Vitamins and minerals', 'Hematology', 'Gynecology', 'Glucocorticosteroids'];
        ...
        for($i=0; $i<count($ruTitle); $i++) {
            ...
            $c->translations()->where('locale', 'en')->first()->update([
                'title' => $enTitle[$i],
            ]);
        }
    }
